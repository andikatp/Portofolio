  ...
  return (
    <section className="flex flex-col items-center justify-center flex-1 px-4 sm:px-8 md:px-16 w-full py-4 sm:py-8 my-auto gap-3 sm:gap-6 short-compact-gap min-h-0">
      ...
      <motion.div
        ...
        initial="hidden"
        animate={animateState}
        className="mt-2 sm:mt-6 py-2 sm:py-4 items-center border-t border-slate-200 w-full sm:w-3/4 md:w-1/2 flex flex-col gap-y-2 sm:gap-y-5 short-compact-gap"
      >
