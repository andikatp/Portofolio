...
interface WorkDetailImageViewerProps {
  work: WorkItem;
...
export function WorkDetailImageViewer({
  work,
  activeLayoutId,
  images,
  currentImageIndex,
  ...
  onPrevImage,
  onNextImage,
}: WorkDetailImageViewerProps) {
  const currentLayoutId = activeLayoutId;
...
export { WorkDetailImageViewer as WorkDetailViewer };
